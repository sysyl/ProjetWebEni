...
public class UtilisateursManager {
	...
	/**
	 * Méthode en charge de verifier les parametres recus pour
	 * permettre ou empecher l'intanciation d'utilisateur
	 * @param nom, prenom, pseudo, email, businessException
	 */
	...
	/**
	 * Méthode en charge de retourne une instance
