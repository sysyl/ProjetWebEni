...
public class Article {
	...
	public Article(int noArticle, String nomArticle, Integer prixVente, Timestamp finEncheres, Integer noUtilisateur) {
	...
	public Article(int noArticle, String nomArticle, String descriptionArticle, Timestamp debutEncheres,
			Timestamp finEncheres, int prixInitial, int prixVente, Utilisateur utilisateur, Categorie categorie,
			Retrait retrait, String pathImg) {
		this(nomArticle, descriptionArticle, debutEncheres, finEncheres, prixInitial, prixVente, utilisateur, categorie,
				retrait, pathImg);
		setNoArticle(noArticle);
	}

	public Article(String nomArticle, String descriptionArticle, Timestamp debutEncheres, Timestamp finEncheres,
	...
	public Article(String nomArticle, String descriptionArticle, Timestamp debutEncheres, Timestamp finEncheres,
			Utilisateur utilisateur, Categorie categorie, Retrait retrait, String pathImg) {
		setNomArticle(nomArticle);
		setDescriptionArticle(descriptionArticle);
		setDebutEncheres(debutEncheres);
		setFinEncheres(finEncheres);
	...
	public String toString() {
		return "Article [noArticle=" + noArticle + ", nomArticle=" + nomArticle + ", descriptionArticle="
				+ descriptionArticle + ", debutEncheres=" + debutEncheres + ", finEncheres=" + finEncheres
				+ ", prixInitial=" + prixInitial + ", prixVente=" + prixVente + ", utilisateur=" + utilisateur
				+ ", noUtilisateur=" + noUtilisateur + ", categorie=" + categorie + ", retrait=" + retrait
				+ ", pathImg=" + pathImg + "]";
	}
